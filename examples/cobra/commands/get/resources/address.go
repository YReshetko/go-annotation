...
// @Cobra(
//
//	usage = "cli get address",
//	example = "cli get address -a 'Some street, 14'",
//	short = "Get address command of the application (short)",
//	long = "Get address command of the application (long)",
//
// )
...
func (c AddressCommand) Run(cmd *cobra.Command, agrs []string) error {
	fmt.Println("Get address run command", c)
	return nil
}
