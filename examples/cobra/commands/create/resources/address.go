...
// @Cobra(
//
//	usage = "cli create address",
//	example = "cli create address -a 'Some street, 14'",
//	short = "Create address command of the application (short)",
//	long = "Create address command of the application (long)",
//
// )
...
func (c AddressCommand) Run(cmd *cobra.Command, agrs []string) error {
	fmt.Println("Create address run command", c)
	return nil
}
