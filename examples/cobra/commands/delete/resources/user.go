...
// @Cobra(
//
//	usage = "cli delete user",
//	example = "cli delete user -g male -n John -l Doe -s 5",
//	short = "Delete user command of the application (short)",
//	long = "Delete user command of the application (long)",
//
// )
...
func (c UserCommand) Run(cmd *cobra.Command, agrs []string) error {
	fmt.Println("Delete user run command", c)
	return nil
}
