...
// @Cobra(
//
//	usage = "cli delete address",
//	example = "cli delete address -a 'Some street, 14'",
//	short = "Delete address command of the application (short)",
//	long = "Delete address command of the application (long)",
//
// )
...
func (c AddressCommand) Run(cmd *cobra.Command, agrs []string) error {
	fmt.Println("Delete address run command", c)
	return nil
}
