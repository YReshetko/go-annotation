...
type SomeInternalHandlerOverrodeMock struct {
...
func (fake *SomeInternalHandlerOverrodeMock) Handle(arg1 http.Request) (http.Response, error) {
...
func (fake *SomeInternalHandlerOverrodeMock) HandleCallCount() int {
	fake.handleMutex.RLock()
	defer fake.handleMutex.RUnlock()
	return len(fake.handleArgsForCall)
}

func (fake *SomeInternalHandlerOverrodeMock) HandleCalls(stub func(http.Request) (http.Response, error)) {
	fake.handleMutex.Lock()
	defer fake.handleMutex.Unlock()
	fake.HandleStub = stub
}

func (fake *SomeInternalHandlerOverrodeMock) HandleArgsForCall(i int) http.Request {
	fake.handleMutex.RLock()
	defer fake.handleMutex.RUnlock()
...
func (fake *SomeInternalHandlerOverrodeMock) HandleReturns(result1 http.Response, result2 error) {
	fake.handleMutex.Lock()
	defer fake.handleMutex.Unlock()
	fake.HandleStub = nil
...
func (fake *SomeInternalHandlerOverrodeMock) HandleReturnsOnCall(i int, result1 http.Response, result2 error) {
	fake.handleMutex.Lock()
	defer fake.handleMutex.Unlock()
	fake.HandleStub = nil
...
func (fake *SomeInternalHandlerOverrodeMock) Proxy() handlers.SomeHandler {
...
func (fake *SomeInternalHandlerOverrodeMock) ProxyCallCount() int {
	fake.proxyMutex.RLock()
	defer fake.proxyMutex.RUnlock()
	return len(fake.proxyArgsForCall)
}

func (fake *SomeInternalHandlerOverrodeMock) ProxyCalls(stub func() handlers.SomeHandler) {
	fake.proxyMutex.Lock()
	defer fake.proxyMutex.Unlock()
	fake.ProxyStub = stub
}

func (fake *SomeInternalHandlerOverrodeMock) ProxyReturns(result1 handlers.SomeHandler) {
	fake.proxyMutex.Lock()
	defer fake.proxyMutex.Unlock()
	fake.ProxyStub = nil
...
func (fake *SomeInternalHandlerOverrodeMock) ProxyReturnsOnCall(i int, result1 handlers.SomeHandler) {
	fake.proxyMutex.Lock()
	defer fake.proxyMutex.Unlock()
	fake.ProxyStub = nil
...
func (fake *SomeInternalHandlerOverrodeMock) SetProxy(arg1 handlers.SomeHandler) error {
...
func (fake *SomeInternalHandlerOverrodeMock) SetProxyCallCount() int {
	fake.setProxyMutex.RLock()
	defer fake.setProxyMutex.RUnlock()
	return len(fake.setProxyArgsForCall)
}

func (fake *SomeInternalHandlerOverrodeMock) SetProxyCalls(stub func(handlers.SomeHandler) error) {
	fake.setProxyMutex.Lock()
	defer fake.setProxyMutex.Unlock()
	fake.SetProxyStub = stub
}

func (fake *SomeInternalHandlerOverrodeMock) SetProxyArgsForCall(i int) handlers.SomeHandler {
	fake.setProxyMutex.RLock()
	defer fake.setProxyMutex.RUnlock()
...
func (fake *SomeInternalHandlerOverrodeMock) SetProxyReturns(result1 error) {
	fake.setProxyMutex.Lock()
	defer fake.setProxyMutex.Unlock()
...
func (fake *SomeInternalHandlerOverrodeMock) SetProxyReturnsOnCall(i int, result1 error) {
	fake.setProxyMutex.Lock()
	defer fake.setProxyMutex.Unlock()
	fake.SetProxyStub = nil
...
func (fake *SomeInternalHandlerOverrodeMock) Invocations() map[string][][]interface{} {
...
func (fake *SomeInternalHandlerOverrodeMock) recordInvocation(key string, args []interface{}) {
...
var _ handlers.SomeInternalHandler = new(SomeInternalHandlerOverrodeMock)
