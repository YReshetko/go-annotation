...
const (
	handlerComment = `// Code generated by @Rest annotation processor. DO NOT EDIT.
`
...
func (o *output) get() map[annotation.Path]annotation.Data {
	out := map[annotation.Path]annotation.Data{}
	for k, buf := range o.files {
		out[annotation.Path(k.dir+"/"+"rest.handlers.gen.go")] = annotation.Data(buf.String())
	}
	return out
}
...
func (o *output) upsertBuffer(k outputKey) *bytes.Buffer {
	...
	b := bytes.NewBufferString(handlerComment + fmt.Sprintf(handlerPackage, k.pkg) + handlerImports + "\n")
	o.files[k] = b
	return b
}
