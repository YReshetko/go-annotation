...
func (b *cacheBuilder[K, V]) setVarPrefix(v string) *cacheBuilder[K, V] {
	b.value.varPrefix = v
	return b
}

func (b *cacheBuilder[K, V]) setImports(v map[Import]struct{}) *cacheBuilder[K, V] {
	b.value.imports = v
	return b
}

func (b *cacheBuilder[K, V]) setNode(v *utils.Node[K, V]) *cacheBuilder[K, V] {
	b.value.node = v
	return b
}
